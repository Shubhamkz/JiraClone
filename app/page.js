          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="mt-2 text-base text-gray-600">
                Plan and track your sprints with our intuitive interface. Set
                goals and deadlines with ease.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="mt-2 text-base text-gray-600">
                Assign tasks, track progress, and communicate with your team all
                in one platform.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="mt-2 text-base text-gray-600">
                Monitor how much time is spent on tasks and optimize your
                workflow.
              </p>
            </div>
          </div>
        ...
        <div className="mt-24 bg-white rounded-lg shadow-md p-8">
          <div className="max-w-3xl mx-auto text-center">
            <blockquote className="text-xl italic text-gray-600">
              "JiraClone has transformed how our team manages projects. The
              intuitive interface and powerful features have helped us increase
              productivity by 40%."
            </blockquote>
            <div className="mt-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                © 2023 JiraClone. All rights reserved.
              </p>
            </div>
